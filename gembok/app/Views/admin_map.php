...
<div class="card">
    <div class="card-header">
        ...
        <div style="display: flex; gap: 0.5rem;">
            ...
            <button class="btn btn-secondary btn-sm" onclick="map.setView([-6.200000, 106.816666], 12)">
...
<script>
            ...
            .then(data => {
                ...
                data.forEach(loc => {
                    if (loc.lat && loc.lng) {
                        ...
                        // distinct click handler removed as it conflicts or is redundant if we have edit button inside popup
                        // actually user said "klik marker untuk melihat detail". Popup does exactly that.
                        // "Edit" button inside popup opens modal.
                        markers.push(marker);
                    }
                });
            })
    ...
    async function loadPopupDetails(serial, savedName) {
        ...
        try {
            ...
            // Helpers
            const getVal = (path) => {
                let v = path; // reduced lookup logic
    ...
    async function quickEditWifi(e, serial) {
        e.preventDefault();
