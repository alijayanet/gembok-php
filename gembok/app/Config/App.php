...
class App extends BaseConfig
{
     ...
     * 
     * Priority:
     * 1. Value from .env (app.baseURL)
     * 2. Auto-detect from $_SERVER (production-ready)
    ...
    /**
     * Constructor - Auto-detect baseURL
     */
    public function __construct()
    {
        parent::__construct();
        
        // Priority 1: Check .env for app.baseURL
        ...
        // Priority 2: Auto-detect from $_SERVER (production mode)
        if (isset($_SERVER['HTTP_HOST'])) {
            ...
            // Extract base path (e.g., /gembok-php/public or just /public or /)
            if (strpos($scriptName, '/public/') !== false) {
                // Running from public folder
                $basePath = substr($scriptName, 0, strpos($scriptName, '/public/') + 8); // Include /public/
            } elseif (strpos($scriptName, 'public/index.php') !== false) {
                $basePath = substr($scriptName, 0, strpos($scriptName, 'public/index.php')) . 'public/';
            } else {
                // Assume public is root
                $basePath = '/';
            }
        ...
        $this->baseURL = 'http://localhost/gembok-php/public/';
    }
}
